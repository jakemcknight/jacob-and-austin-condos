...
export async function generateMetadata({ params }: ListingPageProps): Promise<Metadata> {
  ...
  if (listing) {
    ...
    const ogImage = listing.photos && listing.photos.length > 0
      ? `https://jacobinaustin.com/api/mls/photo/${listing.listingId}/0`
      : `https://jacobinaustin.com/images/og-default.jpg`;
...
function renderActiveListing(
  ...
  const structuredData = {
    ...
    about: {
      ...
      ...(listing.photos && listing.photos.length > 0 ? { image: `https://jacobinaustin.com/api/mls/photo/${listing.listingId}/0` } : {}),
    },
    offers: {
      "@type": "Offer",
